        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a className="cart-link" href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <span className="cart_quantity_count">{getTotalItems()}</span>
                    ...
                    <div className={set.category}>
                        ...
                        <ul className="product-list">
                            ...
                            <li className="product-card">
                                ...
                                <button
                                    className={cart.find(added => added.name === plant.name) ? "product-button added-to-cart" : "product-button"}
                                    onClick={() => handleAddToCart(plant)}
                                    {...(cart.find(added => added.name === plant.name) && { disabled: true })}
                                >Add to Cart</button>
                            </li>
                            )) }
                        </ul>
